...
import {Field,Form,Tag,Button,Image as VanImage,Card,Tab, Tabs,Swipe, SwipeItem, Lazyload, Badge,Sidebar, SidebarItem,Collapse, CollapseItem} from 'vant';

createApp(App)
    .use(Field).use(Form).use(Button).use(Tag).use(VanImage).use(Card).use(Tab).use(Tabs ).use(Swipe).use(SwipeItem).use(Lazyload, {
